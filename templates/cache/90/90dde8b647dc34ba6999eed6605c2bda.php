...
\t\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["link"]) {
            // line 32
            yield "                      <li>
                          <a class=\"block py-2 px-3 text-blue-600 rounded bg-blue-700 ";
            // line 33
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["link"], "id", [], "any", false, false, false, 33) == CoreExtension::getAttribute($this->env, $this->source, ($context["articles"] ?? null), "category_id", [], "any", false, false, false, 33))) {
                yield " text-pink-600";
            }
...
<footer>
    ...
    {
        return array (  171 => 52,  163 => 7,  155 => 6,  143 => 54,  141 => 52,  128 => 42,  124 => 41,  120 => 40,  117 => 39,  107 => 35,  101 => 34,  95 => 33,  92 => 32,  88 => 31,  69 => 15,  65 => 14,  56 => 8,  52 => 7,  48 => 6,  41 => 1,);
    }
...
<head>
    ...
    <meta name=\"description\" content=\"{% block description %}All about IT and New from Software Development and Hardware{% endblock %}\" name=\"description\">
...
\t\t\t\t\t\t{% for link in navigation %}
                      <li>
                          <a class=\"block py-2 px-3 text-blue-600 rounded bg-blue-700 {% if (link.id == articles.category_id)%} text-pink-600{%endif%} hover:text-pink-600 md:bg-transparent  md:p-0 dark:text-white md:dark:text-blue-500\"
