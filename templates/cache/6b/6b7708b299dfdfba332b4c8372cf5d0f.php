...
<main class=\"flex flex-wrap container mx-auto\">
    <section>
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "image_file", [], "any", false, false, false, 10)) {
            ...
            yield "\"
             alt=\"";
            // line 12
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "image_alt", [], "any", false, false, false, 12), "html", null, true);
            yield "\">
        ";
        } else {
            // line 14
    ...
    <section>
        ...
        // line 19
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["article"] ?? null), "created", [], "any", false, false, false, 19), "html", null, true);
        yield "</div>
...
<main class=\"flex flex-wrap container mx-auto\">
    ...
    <section>
        ...
        <div class=\"text-gray-500 mb-3\">{{article.created}}</div>
